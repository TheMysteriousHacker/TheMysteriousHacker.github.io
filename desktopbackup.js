...
function addTable(bbColor, hColor, hbgColor, hbColor, fontW){
	...
	$("body").append('<CENTER><table id="fTable" style="color:' + hColor + ';background-color:' + bbColor + '"><tr><td rowspan="4" style="width:150px;text-align:center"><a href="../../index.html"><img alt="click here to go to the main page" id="drvitimg" src="../../pictures/link2.png"></a></td><td class="tdpadding" style="border-color:' + hbColor + ';background-color:' + hbgColor + ';border-top-style:solid">If you found a problem in this website or a maths-related mistake, <a href="../../submitpage1.html" style="color:' + hColor +'">click here</a></td><td rowspan="3" style="border-color:' + hbColor + ';background-color:' + hbgColor + ';border-right-style:solid;text-align:center;border-bottom-style:solid;border-top-style:solid"><A HREF="http://www.aprelium.com"><IMG SRC="../../pictures/pwrabyss.gif" ALT="Powered by Abyss Web Server" TITLE="Powered by Abyss Web Server" id="abyss" style="border-style:solid;border-color:' + hbColor + '"></A></td></tr><tr><td class="tdpadding" style="border-color:' + hbColor + ';background-color:' + hbgColor + '">If there are any equations for which you want proof for, <a href="../../submitpage2.html" style="color:' + hColor + '">click here</a></td></tr><tr><td class="tdpadding" style="border-color:' + hbColor + ';background-color:' + hbgColor + ';border-bottom-style:solid">For any suggestion and ideas, <a href="../../submitpage3.html" style="color:' + hColor + '">click here</a></td></tr><tr><td colspan="2">lol</td></tr></table></CENTER>');
...
if (checkId == "body1"){
	...
	$("head").append('<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="icon" type="image/png" href="../../pictures/logo.png">').ready(function(){
		...
		if((document.cookie != "") &&(document.cookie.slice(document.cookie.indexOf("brown=")+6) == "yes")){
			$('#sideButton .setting #selector i').attr('class') == "fa fa-times";
			darkmode()
		};
	})
}
